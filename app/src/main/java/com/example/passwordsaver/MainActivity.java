...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<String> password_id, password_name, pasword_username, password_password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password_name = new ArrayList<>();
        pasword_username = new ArrayList<>();
        password_password = new ArrayList<>();

        storeDataInArrays();

        customAdapter = new CustomAdapter(MainActivity.this, this, password_id, password_name, pasword_username,
                password_password);
    ...
    void storeDataInArrays() {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                password_name.add(cursor.getString(1));
                pasword_username.add(cursor.getString(2));
                password_password.add(cursor.getString(3));
            }
